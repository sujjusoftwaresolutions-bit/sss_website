    ...
    <section className="py-24 bg-[#050B14] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="absolute -inset-4 bg-gradient-to-tr from-brand-gold to-transparent rounded-2xl blur-lg opacity-20 animate-pulse" />
            <div className="relative glass-dark bg-[#081225] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              {/* Placeholder for actual CivicSense AI dashboard screenshot */}
              <div className="aspect-[4/3] bg-[#050B14] relative flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1000&q=80')] bg-cover bg-center opacity-20 mix-blend-overlay" />
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-outfit leading-tight">
              CivicSense AI: <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-light-gold to-brand-gold">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
              {features.map((feature, idx) => (
                <motion.li 
                  ...
                  className="flex items-center gap-3 text-gray-300 font-inter font-medium bg-[#081225] border border-white/5 px-4 py-3 rounded-lg shadow-sm"
                >
                  {feature.icon}
            ...
            <Link to="/civicsense-ai">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-brand-gold text-[#050B14] font-bold rounded-lg hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all duration-300"
              >
